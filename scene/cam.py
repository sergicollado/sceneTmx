...
class Camera:
    ...
    def update(self):
        ...
        self.position.y += int(self.speed.velocity.vertical)
        self.speed.update()

    
    def __str__(self):
        return 'position: '+ str(self.position.x)+',' +str(self.position.y)+' speed: '+ str(self.speed.velocity.horizontal)+','+str(self.speed.velocity.vertical) 